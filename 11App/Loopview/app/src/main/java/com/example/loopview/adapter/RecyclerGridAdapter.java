package com.example.loopview.adapter;
...
import com.example.loopview.R;
import com.example.loopview.bean.GoodsInfo;
import com.example.loopview.widget.RecyclerExtras.OnItemClickListener;
import com.example.loopview.widget.RecyclerExtras.OnItemLongClickListener;

public class RecyclerGridAdapter<ViewHolder extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<ViewHolder> implements OnItemClickListener, OnItemLongClickListener{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
        ...
        return (ViewHolder) new ItemHolder(v);
    }
